        ...
        <div className="fixed inset-0 z-20 bg-[black]/80 flex items-center justify-center">
            ...
            <div className="max-w-[1200px] w-full bg-white-100  lg:flex-row shadow-purple rounded-lg py-5 flex flex-col gap-3 relative pt-5">
                ...
                <div className="px-3 lg:w-1/2 pt-10">
                    ...
                    <div className="shadow items-center w-full bg-white-100/20 rounded-md flex py-10 flex-col  md:px-5 px-1  flex-1 justify-center relative bg-white-200 border">

                        {postDescription
                            ? <h1 className="py-4 text-[20px] font-thin font-sans text-left w-full text-black-100 border-b my-2 bg-transparent focus:outline-none"> {postDescription} </h1>
                            : <div>
                        ...
                        <CopyToClipboard className="absolute top-3 right-3" size={25} text={selectClipboardCopy()} />
